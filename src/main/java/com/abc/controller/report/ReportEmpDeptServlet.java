...
@WebServlet(name = "ReportEmpDeptServlet",urlPatterns = "/empfindbyvo")
public class ReportEmpDeptServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Res<List<EmpDto>> res = reportService.makeReportForDeptEmp(deptEmpVo);
